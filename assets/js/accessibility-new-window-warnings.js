...
const classPrefix = window.edac_frontend_fixes?.new_window_warning?.classPrefix || window.anww_localized?.classPrefix || 'anww';
const localizedString = window.edac_frontend_fixes?.new_window_warning?.localizedString || window.anww_localized?.opens_a_new_window || 'opens a new window';
